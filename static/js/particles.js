...
window.onload = function() {
  Particles.init({
    selector: '.background', // Targets the canvas with class "background"
    color: '#474545', // White particles (can also use '#fff')
    connectParticles: true, // Draw lines between particles
    maxParticles: 90, // Number of particles
    sizeVariations: 0.2, // Vary particle sizes
    speed: 0.4 // Particle movement speed
  });

  // Ensure the canvas covers the whole page
